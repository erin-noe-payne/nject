...
/*
 * Convenience function for printing log messages
 */
...
/**
 * Clears the resolved state of a dependency and causes it to be destroyed.
 *
...
/**
 * Resolves one or more dependencies on the the tree.
 *
 * @param key optional {String} -
 *  The name of the dependency to resolve. If not provided, the entire tree is resolved. Returns an
 *  object whose key value pairs are each registered dependency and its resolved value.
...
/**
 * Clears the resolved state of the entire tree and causes each resolved context to emit the destroy
 * event.
 */
