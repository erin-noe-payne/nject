...
/*
 Registers a module for dependency injection
 key String name of the dependency
 fn Function that will be executed to inject dependencies
 identifier String specific identifier for the module to be used in error messaging
 */
exports.register = function (key, fn, identifier) {
